        ...
        with conn.cursor() as cur:
            ...
            users = [
                ...
                (
                    2,
                    'prof.renatta',
                    'renatta@academichub.edu.br',
                    md5('criptografia1'),
                    'professor',
                    'Prof. Dr. Renatta Nigro',
                    None,
                    4.0,
                ...
                (
                    3,
                    'prof.gaby',
                    'gaby@academichub.edu.br',
                    md5('iloveteaching'),
                    'professor',
                    'Profa. Gaby',
                    None,
                    4.0,
                    'Docente de Banco de Dados.'
                ),
                (
                    4,
                    'guilherme',
                    'guilherme@aluno.academichub.edu.br',
                    md5('senha123'),
                    'aluno',
                    'Guilherme Alves',
                    'A2024001',
                ...
                (
                    5,
                    'matheus',
                    'matheus@aluno.academichub.edu.br',
                    md5('cesarschool'),
                    'aluno',
                    'Matheus Cunha',
                    'A2024002',
            ...
            cur.execute(
                ...
                (
                    1,
                    'Bem-vindos ao semestre 2026/2!',
                    'Prezados alunos e professores, o semestre letivo '
                    '2026/2 está oficialmente iniciado. '
